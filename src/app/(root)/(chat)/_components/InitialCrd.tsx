  ...
  return (
    <div className="flex-1 overflow-auto p-4 flex items-center justify-center">
            <div className="max-w-2xl w-full bg-zinc-800 rounded-xl p-8 flex flex-col items-center">
              <Image src={Hand} alt="hand" className="w-[20%]"/>
              <h1 className="text-white text-3xl font-medium mb-2">Hunting Job Opportunity?</h1>
              <p className="text-zinc-400 text-center text-sm mb-8">
              🚀 Welcome! Simply enter a few details like job preferences, and let AI generate the perfect job listings for you.
              Remember the detailed the prompt the better the response listing.
              </p>
              ...
              <div className="w-full relative">
                <div className="bg-white rounded-lg flex items-center p-2 pr-1">
                  ...
                  />
                  <button className="text-zinc-500 mx-1">
                    <Mic className="w-5 h-5" />
                  </button>
                  <button className="bg-[#b9ff2c] text-white rounded p-1.5">
